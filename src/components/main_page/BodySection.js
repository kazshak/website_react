    ...
    return (
        <div className="col-lg-9 bg-white">
            ...
            <div className="row">
                ...
                <InfoCard header="CURRENT MORTGAGE RATE" contents={flatFee} />
            </div>
